    ...
    public class program
    {
        public static void Main()
        {
            ...
            if (mes > 12)
            {
                while (mes > 12)
                {
                    Console.WriteLine(("el numero sobrepasa la cantidad por favor ingrese un dato correcto"));
                    mes = Convert.ToInt32(Console.ReadLine());
                }
            }


            Console.WriteLine("por favor ingrese el dia ");
            ...
            if (bisiesto == 0 && mes == 2 && dia > 29)
            {
                while (dia > 29)
                {
                    Console.WriteLine(("el numero excede la cantidad de dia"));
                    dia = Convert.ToInt32(Console.ReadLine());
                }
            }
